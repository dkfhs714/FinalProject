...
<body>
  ...
  <div class="container">
  	...
  	<input name="bno" type="hidden" value="${buyboard.bno }"> 
    <div id="tname">제목  </div> <input id="bname" name="bname" value="${buyboard.bname }"> 
	...
	<select name="bcategory" id="bcategory">
 	 ...
 	 <textarea id="bcontent" name="bcontent" rows="8">${buyboard.bcontent }</textarea>
	 <p></p>
	 <div id="tname"> 연락 가능한 전화번호  </div>
 	 <input id="bphone" name="bphone" value=${buyboard.bphone } />
 	 <p></p>
 	 <div id="tname"> 구매 가격 </div>
 	 <input id="bmoney" onKeyup="this.value=this.value.replace(/[^0-9]/g,'');" name="bmoney" value=${buyboard.bmoney } />
 	 <p></p>
 
 	 <div id="tname"> 거래 위치 <button type="button" onclick="execPostCode()">찾기</button> </div>
 	  <input id="baddress" name="baddress" readonly value=${buyboard.baddress } />
 	 </form>
